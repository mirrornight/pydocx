...
from pymdocx.doc.paragraph import merge_paragraph_comment_revision, merge_paragraph_comment_revision_v2
...
def test_merge_paragraph_comment_revision_v2():
    ...
    doc_a = get_doc(doc_file_path_a)
    doc_c = get_doc(doc_file_path_c)
    merge_paragraph_comment_revision_v2(doc_o, [doc_a, doc_c])
